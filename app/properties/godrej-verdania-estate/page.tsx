...
export default function GodrejVerdaniaPage() {
  ...
  const amenitiesData = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1575783970733-1aaedde1db74?q=80&w=1752&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
            ...
            <div className="backdrop-blur-md bg-white/40 border border-white/30 rounded-2xl p-8 shadow-2xl">
              <div className="p-4 bg-gradient-to-r from-gold-50 to-orange-50 border-2 border-gold-300 rounded-xl shadow-lg">
                <div className="text-center">
                  ...
                  <div className="mb-3">
                    <span className="text-2xl font-black text-red-600">Upto ₹20 Lakhs Discount*</span>
                  </div>
