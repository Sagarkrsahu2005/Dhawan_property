          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-400">
                ...
                <div className="flex items-center"><Mail className="w-4 h-4 mr-2" /><span>info@dhawanproperties.in</span></div>
                <div className="flex items-start"><MapPin className="w-4 h-4 mr-2 mt-1" /><span>Sector 14, Gurgaon, Haryana 122001</span></div>
              </div>
            </div>
          </div>
